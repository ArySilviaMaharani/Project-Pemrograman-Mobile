...
public class Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Alert Dialog (Mengklik tombol submit) pada halaman sign in
        //Mendeskripsikan submitButton adalah tombol btn submit yang ada di layout
        Button submitButton = (Button) findViewById(R.id.btn3);

        //Menyiapkan deteksi input object submit
                ...
                AlertDialog.Builder builder = dialogBuilder.setMessage("Apakah anda sudah yakin dengan data berikut?\n\n" +
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                //Intent modul 2
                                //Mengisi Intent bernama i untuk membuka activity typedatastring
                                Intent i = null;
