...
public class Adapter extends RecyclerView.Adapter<Adapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull viewholder holder, @SuppressLint("RecyclerView") int position) {
        holder.number.setText(dataholder.get(position).getNumber());
            ...
            public void onClick(View v) {
                ...
                alertDialog.setNegativeButton("YA", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        db.deleteData(dataholder.get(position).getNumber());
        ...
        holder.button_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("number", dataholder.get(position).getNumber());
    ...
    class viewholder extends RecyclerView.ViewHolder{
        TextView number, name, phone, is_valid;
