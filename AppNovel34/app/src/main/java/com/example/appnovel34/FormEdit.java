...
public class FormEdit extends AppCompatActivity {
    ...
    TextView txt_number, txt_name, txt_phone, txt_gender, txt_age, txt_genre;
    Button button_update;
    RadioGroup radioGroup;
    RadioButton radioButton;

    String number, keterangan, is_valid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBundleExtra("datavaksin") != null) {
            ...
            txt_number.setText(bundle.getString("number"));
        ...
        button_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle bundle = getIntent().getBundleExtra("datavaksin");
                db.updateData(bundle.getString("number"), keterangan, value);
            }
        });
    }
